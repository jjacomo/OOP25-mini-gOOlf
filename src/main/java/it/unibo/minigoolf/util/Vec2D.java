...
//      *
//      * @return a new Vector2D pointing in the given direction with the given magnitude
//      */
//     public static Vector2D fromAngleAndMagnitude(final double angle, final double magnitude) {
...
//      *
//      * @return new Vector2D pointing in the opposite direction
//      */
...
//      *
//      * @return new Vector2D with the same direction but length &lt;= maxLength
//      */
...
//         return new Vector2D(inner.getX() * scale, inner.getY() * scale);
//     }
...
//         return String.format("Vector2D(%.2f, %.2f)", inner.getX(), inner.getY());
//     }
// }
