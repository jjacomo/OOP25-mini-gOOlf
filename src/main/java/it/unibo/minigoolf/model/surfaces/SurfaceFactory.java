 ...
 * This encapsulates the details of surface creation, including default friction coefficients.
 */
public interface SurfaceFactory {
     ...
     * @param zIndex the z-index of the surface for rendering and layering
     * @param typeId the unique identifier for the surface type (used for rendering/styling)
