...
public class MapG implements GameMapFactory {
    ...
    private static final Vector2D O7_VERTEX_B = new Vector2D(849,1049);
    private static final Vector2D O7_VERTEX_C = new Vector2D(999,1049);
    private static final double O7_BOUNCINESS = AbstractObstacle.BOUNCY_BOUNCINESS;

    private static final Vector2D O8_VERTEX_A = new Vector2D(499,31);
    private static final Vector2D O8_VERTEX_B = new Vector2D(649,31);
    private static final Vector2D O8_VERTEX_C = new Vector2D(499,181);
    private static final double O8_BOUNCINESS = AbstractObstacle.BOUNCY_BOUNCINESS;

    private static final Vector2D O9_VERTEX_A = new Vector2D(499,31);
    private static final Vector2D O9_VERTEX_B = new Vector2D(649,31);
    private static final Vector2D O9_VERTEX_C = new Vector2D(499,181);
